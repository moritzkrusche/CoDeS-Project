...
var plantSheetPic = document.createElement("img");
var soilSheetPic = document.createElement("img");
...
function loadImages() {
	var imageList = [
		{varName: charSprite, theFile: "farmerSprite240px.png"},
        {varName: potato1, theFile: "potato50px.png"},
        {varName: potato2, theFile: "potato50px.png"},
        {varName: potato3, theFile: "potato50px.png"},
        {varName: uiPic, theFile: "uiPanelDesktop.png"},

        {varName: soilSheetPic, theFile: "soilSheet100px.png"},
        {varName: plantSheetPic, theFile: "plantSheet60px.png"}
		];
